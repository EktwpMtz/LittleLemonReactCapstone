    ...
    return (
        <section className="booking">
            ...
            <article className='booking-process'>
                <img src="/assets/booking-image.jpg" alt="Booking Image" className="booking-image" />
                    ...
                    step === 1 ? (
                        <div className='booking-form' data-step={1}>
                            <form>
                                ...
                                <br />
                                <button type="submit" onClick={handleNextStep}>Continue</button>
                            </form>
                            <div>
                                <h2>Special Offers</h2>
                                <p>Book a table for 4 or more and get a free dessert!</p>
                                <h3>Important Information</h3>
                                <p>Please arrive 10 minutes before your reservation time. We look forward to serving you!</p>
                            </div>
                        </div>
                    ) : (
                        <div className='booking-form' data-step={2}>
                            ...
                            <div>
                                ...
                                <p>You can modify your reservation up to 24 hours before your scheduled time.</p>
                            </div>
                        </div>
                    )
                }
